# Module 5 intro video — No-code experiments you can ship
...
*(0:00–0:25)*  
Welcome to Module 5 of **No-Code Machine Learning Intuition** on The Ai Master Class. Design a one-week no-code ML experiment with kill/keep rules.

*(0:25–0:55)*  
We will stay with fictional **Northstar Studio** and **Acme Ops** — classroom-safe scenarios, no real PII.

*(0:55–1:40)*  
This hour covers: Pick a question before you pick a tool; No-code ML platforms: a field guide; Design a one-week experiment; Ship, measure, kill or keep.
...
3. Diagram `diagram-experiment-loop.svg`.
