...
3. Open `l03-interactive.html` and follow its Instructions until you hit the success state (this locks in: Cross-validation intuition (no math)).
4. Rewrite or apply the idea once in your own words (one sentence is enough).
5. **You’re done when:** you can explain — in plain language — *Describe k-fold and when time-series forbids it.* and `l03-interactive.html` shows success.
