# Module 1 intro video — Your AI desk setup

**Length:** ~3–5 minutes  
**Tone:** Confident, practical, Monday-morning  
**Visual:** Dark premium edtech; accent `#3b82f6` → `#8b5cf6`
...
*(0:00–0:25)*  
Welcome to Module 1 of **AI for Work: ChatGPT & Claude** on The Ai Master Class. Stand up a reliable ChatGPT + Claude desk: pick the right tool, lock habits, set custom instructions, and run a weekly ritual that ships Monday morning.
...
*(0:55–1:40)*  
You’ll cover: ChatGPT vs Claude: pick the right desk tool, Browser, apps, and workspace habits that stick, Custom instructions and memory that serve you, Your weekly AI ritual (ship Monday morning). Each lesson pairs teaching with an interactive drill and success criteria.
...
| Time | Bullet |
|------|--------|
| 0:20 | Module 1: Your AI desk setup |
...
3. Animated diagram (`diagram-ai-desk.svg`).  
