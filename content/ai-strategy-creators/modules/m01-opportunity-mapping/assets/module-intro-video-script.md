# Module 1 intro video — AI opportunity mapping for your niche

**Length:** ~3–5 minutes  
**Tone:** Confident, practical, Monday-morning  
**Visual:** Dark premium edtech; accent `#a855f7` -> `#ef4444`
...
*(0:00–0:25)*  
Welcome to Module 1 of **AI Strategy for Creators & Founders** on The Ai Master Class. Map niche pain to AI leverage and score opportunities by leverage times proof.

*(0:25–0:55)*  
We will stay with fictional **Northstar Studio** and **Acme Ops** — classroom-safe scenarios, no real PII.

*(0:55–1:40)*  
This hour covers: Map pain to AI leverage in your niche; Build vs buy vs wrap decisions; Score opportunities by leverage x proof.
...
3. Diagram `diagram-opportunity-map.svg`.
