# Module 2 example video — Instructions that stick demo
...
Apply this module’s method live: Write assistant instructions as a durable behavior contract: mission, non-goals, hard rules, style, and output shape—without a 10,000-word novel.

Walk the diagram `diagram-instruction-layers.svg` and one interactive success path.
...
“Capture one Monday-morning action. Next: `m03-files-knowledge-boundaries`.”
