# Module 1 example video — Anatomy of a custom assistant demo
...
Apply this module’s method live: Map the surfaces of a shareable assistant—instructions, knowledge, actions, starters, and sharing—so you stop treating a Custom GPT like a longer chat prompt.

Walk the diagram `diagram-assistant-anatomy.svg` and one interactive success path.
...
“Capture one Monday-morning action. Next: `m02-instructions-that-stick`.”
