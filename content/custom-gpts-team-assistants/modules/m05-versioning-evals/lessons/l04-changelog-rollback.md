...
3. Open `l04-interactive.html` and follow its Instructions until you hit the success state (this locks in: Changelog & rollback playbooks).
4. Capture a one-sentence Monday-morning takeaway you could paste into Slack.
5. **You’re done when:** you can explain — in plain language — *Document how to roll back to the last good version within minutes when production assistants misbehave.* and `l04-interactive.html` shows success.
