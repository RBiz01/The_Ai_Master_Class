# Module 3 example video — Files, knowledge & boundaries demo
...
Apply this module’s method live: Curate knowledge packs with freshness rules and refuse/escalate/cite boundaries—so assistants stay useful without leaking or hallucinating policy.

Walk the diagram `diagram-knowledge-boundaries.svg` and one interactive success path.
...
“Capture one Monday-morning action. Next: `m04-actions-and-tools`.”
