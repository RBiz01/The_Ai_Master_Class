# Module 8 example / demo video — Ops, cost control, and monitoring
...
*(0:00–0:30)*  
Demo time. We’ll walk **Walk Acme Ops cost spike incident with kill switch.** using fictional Acme Ops data only—no real API keys.
...
*(6:00–7:00)*  
Recap takeaways tied to Module 8 lessons. Invite learners to the interactives.
