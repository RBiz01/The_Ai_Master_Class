...
3. Open `l02-interactive.html` and follow its Instructions until you hit the success state (this locks in: Building eval harnesses).
4. Capture a one-sentence Monday-morning takeaway you could paste into Slack.
5. **You’re done when:** you can explain — in plain language — *Build a tiny harness: fixtures, expected tool sequence, assertions, scorecard.* and `l02-interactive.html` shows success.
