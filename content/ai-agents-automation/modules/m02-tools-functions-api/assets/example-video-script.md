# Module 2 example / demo video — Tools, functions, and API wiring
...
*(0:00–0:30)*  
Demo time. We’ll walk **Wire get_ticket + search_kb for Acme Ops with safe defaults.** using fictional Acme Ops data only—no real API keys.
...
*(6:00–7:00)*  
Recap takeaways tied to Module 2 lessons. Invite learners to the interactives.
