# Module 3 example / demo video — Planning, memory, and state
...
*(0:00–0:30)*  
Demo time. We’ll walk **Design state + memory for Acme Ops triage agent.** using fictional Acme Ops data only—no real API keys.
...
*(6:00–7:00)*  
Recap takeaways tied to Module 3 lessons. Invite learners to the interactives.
