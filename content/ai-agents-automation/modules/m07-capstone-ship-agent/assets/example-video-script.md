# Module 7 example / demo video — Capstone: ship a reliable agent
...
*(0:00–0:30)*  
Demo time. We’ll walk **Ship Acme Ops Vendor Risk Triage Agent checklist.** using fictional Acme Ops data only—no real API keys.
...
*(6:00–7:00)*  
Recap takeaways tied to Module 7 lessons. Invite learners to the interactives.
