...
3. Open `l02-interactive.html` and follow its Instructions until you hit the success state (this locks in: Bridging agents to workflow tools).
4. Capture a one-sentence Monday-morning takeaway you could paste into Slack.
5. **You’re done when:** you can explain — in plain language — *Design a bridge: workflow calls agent HTTP, agent returns structured JSON.* and `l02-interactive.html` shows success.
