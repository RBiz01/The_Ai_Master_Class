# Module 6 example / demo video — No-code and low-code automation bridges
...
*(0:00–0:30)*  
Demo time. We’ll walk **Bridge Acme Ops Make scenario to triage agent.** using fictional Acme Ops data only—no real API keys.
...
*(6:00–7:00)*  
Recap takeaways tied to Module 6 lessons. Invite learners to the interactives.
