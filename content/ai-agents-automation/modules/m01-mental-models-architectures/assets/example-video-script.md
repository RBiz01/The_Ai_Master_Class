# Module 1 example / demo video — Agent mental models & architectures
...
*(0:00–0:30)*  
Demo time. We’ll walk **Map Acme Ops vendor-risk triage onto SPAO and choose single-agent.** using fictional Acme Ops data only—no real API keys.
...
*(6:00–7:00)*  
Recap takeaways tied to Module 1 lessons. Invite learners to the interactives.
